...
export const Navbar = () => {
    ...
    <div>
      <AppBar position="fixed" className="abcd">
        <Toolbar sx={{ display: 'flex',flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', backgroundColor: '#ffffff' , color: 'black', height: '12vh', fontWeight: '600'}}>
          <Stack direction='row' spacing={2}  alignItems = 'center' justifyContent={'space-evenly'} flexBasis={'50%'}>
          <Stack direction='row' spacing={3} sx={{display: 'flex',flexDirection: 'row' , textAlign: 'center', justifyContent: 'center', alignItems: 'center'}}  >
